...
public class GlobalExceptionHandlerMiddleware
{
    ...
    private const string ServiceName = "BillingService";
    ...
    private async Task HandleDbUpdateExceptionAsync(HttpContext context, DbUpdateException ex)
    {
        ...
        if (ex.InnerException is PostgresException pgEx)
        {
            ...
            _logger.LogWarning(ex,
                ...
                correlationId, pgEx.SqlState, pgEx.ConstraintName, pgEx.TableName, "BillingService", context.Request.Path);
        ...
        _logger.LogError(ex,
            ...
            correlationId, "BillingService", context.Request.Path, ex.InnerException?.GetType().Name ?? "None");
    ...
    private async Task HandleUnhandledExceptionAsync(HttpContext context, Exception ex)
    {
        ...
        _logger.LogError(ex,
            ...
            correlationId, "BillingService", context.Request.Path, ex.GetType().Name, ex.InnerException?.GetType().Name ?? "None");

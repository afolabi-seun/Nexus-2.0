...
public class GlobalExceptionHandlerMiddleware
{
    ...
    private async Task HandleDomainExceptionAsync(HttpContext context, DomainException ex)
    {
        ...
        _logger.LogWarning(
            ...
            correlationId, ex.ErrorCode, ex.ErrorValue, "ProfileService", context.Request.Path);
    ...
    private async Task HandleDbUpdateExceptionAsync(HttpContext context, DbUpdateException ex)
    {
        ...
        if (ex.InnerException is PostgresException pgEx)
        {
            ...
            _logger.LogWarning(ex,
                ...
                correlationId, pgEx.SqlState, pgEx.ConstraintName, pgEx.TableName, "ProfileService", context.Request.Path);
        ...
        _logger.LogError(ex,
            ...
            correlationId, "ProfileService", context.Request.Path, ex.InnerException?.GetType().Name ?? "None");
    ...
    private async Task HandleUnhandledExceptionAsync(HttpContext context, Exception ex)
    {
        ...
        _logger.LogError(ex,
            ...
            correlationId, "ProfileService", context.Request.Path, ex.GetType().Name, ex.InnerException?.GetType().Name ?? "None");
        ...
        string errorCode, string message, string severity, string? stackTrace)
    {
        try
        {
            ...
            await outboxService.PublishAsync(envelope);

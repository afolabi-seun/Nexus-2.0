...
public class GlobalExceptionHandlerMiddleware
{
    ...
    private async Task HandleDbUpdateExceptionAsync(HttpContext context, DbUpdateException ex)
    {
        ...
        if (ex.InnerException is PostgresException pgEx)
        {
            ...
            _logger.LogWarning(ex,
                ...
                correlationId, pgEx.SqlState, pgEx.ConstraintName, pgEx.TableName, "SecurityService", context.Request.Path);
        ...
        _logger.LogError(ex,
            ...
            correlationId, "SecurityService", context.Request.Path, ex.InnerException?.GetType().Name ?? "None");
    ...
    private async Task HandleUnhandledExceptionAsync(HttpContext context, Exception ex)
    {
        ...
        _logger.LogError(ex,
            ...
            correlationId, "SecurityService", context.Request.Path, ex.GetType().Name, ex.InnerException?.GetType().Name ?? "None");
